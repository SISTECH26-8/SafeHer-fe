...
export default function MainLayout({ children }: MainLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 font-sans flex flex-col relative w-full overflow-x-hidden">
      ...
      {/* Footer */}
      <footer className="w-full bg-sistech-pink text-white pt-8 md:pt-12 pb-6 md:pb-6 px-4 md:px-8 mt-auto">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-8 md:gap-4 mb-8 md:mb-8">
          ...
          <div className="w-full md:w-1/3 max-w-xs">
            ...
            <div className="flex space-x-3">
              <a href="#" className="w-8 h-8 rounded-full bg-white flex items-center justify-center hover:scale-110 transition-transform">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-sistech-pink w-4 h-4"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
              </a>
              <a href="#" className="w-8 h-8 rounded-full bg-white flex items-center justify-center hover:scale-110 transition-transform">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-sistech-pink w-4 h-4"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
              </a>
              <a href="#" className="w-8 h-8 rounded-full bg-white flex items-center justify-center hover:scale-110 transition-transform">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-sistech-pink w-4 h-4"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/></svg>
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-24 w-full md:w-auto">
            ...
            <div className="flex flex-col space-y-2 md:space-y-3">
              <h3 className="font-bold text-sm md:text-lg mb-1 md:mb-1">Navigasi</h3>
              <Link href="/" className="text-xs md:text-sm text-white/90 hover:text-white transition-colors">Beranda</Link>
              <Link href="/route" className="text-xs md:text-sm text-white/90 hover:text-white transition-colors">Rute Aman</Link>
              <Link href="/report" className="text-xs md:text-sm text-white/90 hover:text-white transition-colors">Lapor Anonim</Link>
              <Link href="#" className="text-xs md:text-sm text-white/90 hover:text-white transition-colors">Tentang Kami</Link>
            </div>

            {/* Help Links */}
            <div className="flex flex-col space-y-2 md:space-y-3">
              <h3 className="font-bold text-sm md:text-lg mb-1 md:mb-1">Bantuan</h3>
              <a href="#" className="text-xs md:text-sm text-white/90 hover:text-white transition-colors">FAQ</a>
              <a href="#" className="text-xs md:text-sm text-white/90 hover:text-white transition-colors">Pusat Bantuan</a>
              <a href="#" className="text-xs md:text-sm text-white/90 hover:text-white transition-colors">Kontak Kami</a>
            </div>
          </div>
        </div>
